...
<html lang="en" id="areaprint">
  ...
  <body>
    <header class="clearfix">
      <div id="logo">
        <img src="<?php echo base_url();?>invoice/logo.png">
      </div>
      <h1>NO PEMBAYARAN : <?php echo $rkwitansi['id_pembayaran'];?></h1>
      <div id="company" class="clearfix">
        <div>SMK Labor Binaan FKIP Unri Pekanbaru</div>
        <div>Jl. Thamrin No.97 Kec. Tenayan Raya,<br /> Prov. Riau</div>
        <div>(0761) 28760</div>
        <div><a href="#">www.smklabor.sch.id</a></div>
      </div>
      <div id="project">
      ...
      <table>
        ...
        <tbody>
          <tr>
            ...
            <td colspan="" class="grand total">TOTAL</td>
