...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Data Petugas <small>Tampil</small></h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td class="center">
												<div class="tooltip-demo">
                                                    ...
                                                    <a href='#' data-href=<?php echo site_url('datapetugas/hapus/'.$d['id_petugas']);?> data-toggle='modal' data-target='#myModal'>
