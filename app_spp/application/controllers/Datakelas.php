...
class Datakelas extends CI_Controller {
	...
	public function index(){
		...
		if($cek_user_level == 'admin'){
			...
			$this->load->view('tampilandatakelas/v_datakelas',$data);
		}
		else{
			redirect('notfound');
		}
	...
	public function form(){
		...
		if($cek_user_level == 'admin'){
			...
			if ($this->form_validation->run() == TRUE){
				...
				//panggil validation
				$this->load->view('tampilandatakelas/v_datakelasform',$data);
			}
		}
		else{
			redirect('notfound');
		...
		if($cek_user_level == 'admin'){
			...
			if($this->input->post('ubah')){
				...
				if ($this->form_validation->run() == TRUE){
					...
					$this->load->view('tampilandatakelas/v_datakelasformedit',$data);
				}
			}
			else{
