...
class Datapetugas extends CI_Controller {
	...
	public function index(){
		...
		if($cek_user_level == 'admin'){
			...
			$this->load->view('tampilandatapetugas/v_datapetugas',$data);
		}
		else{
			redirect('notfound');
		}
	...
	public function form(){
		...
		if($cek_user_level == 'admin'){
			...
			if ($this->form_validation->run() == TRUE){
				...
				$this->load->view('tampilandatapetugas/v_datapetugasform',$data);
			}
		}
		else{			
			redirect('notfound');
			...
			if($this->input->post('ubah')){
				...
				if($this->input->post('passwordedit')==""){
					...
					if ($this->form_validation->run() == TRUE){
						...
						$this->load->view('tampilandatapetugas/v_datapetugasformedit',$data);
					}
				}
				//jika password diisi
				else{
